...
namespace ExtendedChromaKey.Effect
{
    internal sealed class ExtendedChromaKeyEffectProcessor : VideoEffectProcessorBase
    {
        ...
        public override DrawDescription Update(EffectDescription effectDescription)
        {
            ...
            _effect.GradientAngle = (float)(_item.GradientAngle.GetValue(frame, length, fps) * Math.PI / 180.0);
            ...
            _effect.KeyCleanup = (float)_item.KeyCleanup.GetValue(frame, length, fps);
            ...
            _effect.ExceptionGradientAngle = (float)(_item.ExceptionGradientAngle.GetValue(frame, length, fps) * Math.PI / 180.0);
        ...
        {
            _effect = new ExtendedChromaKeyCustomEffect(devices);
