...
namespace ExtendedChromaKey.Services
{
    internal sealed class GraphicsEffectPool : IDisposable
    {
        ...
        public ExtendedChromaKeyCustomEffect Rent(IGraphicsDevicesAndContext devices)
        {
            ...
            return new ExtendedChromaKeyCustomEffect(devices);
        }

        public void Return(IGraphicsDevicesAndContext devices, ExtendedChromaKeyCustomEffect effect)
        {
        ...
        private sealed class Bucket
        {
            ...
            public bool TryRent(out ExtendedChromaKeyCustomEffect? effect)
            {
                lock (_lock)
                {
            ...
            public bool TryReturn(ExtendedChromaKeyCustomEffect effect, int maxSize)
            {
                lock (_lock)
                {
